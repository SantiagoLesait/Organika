...
const { DBNAME, DBPASSWORD } = process.env;
const CONNECTION_URL = `mongodb+srv://Lesait_User:${DBPASSWORD}@cluster0.sx25f.mongodb.net/${DBNAME}?retryWrites=true&w=majority`
